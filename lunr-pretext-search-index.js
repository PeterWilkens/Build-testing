...
var ptx_lunr_docs = [
{
  "id": "preface-about-this-document",
  "level": "1",
  "url": "preface-about-this-document.html",
  "type": "Preface",
  "number": "",
...
{
  "id": "sec-chromatic-button-accordion-intro",
  "level": "1",
  "url": "sec-chromatic-button-accordion-intro.html",
  "type": "Section",
  "number": "1.1",
  "title": "A Chromatic Button Accordion",
  "body": " A Chromatic Button Accordion  The chromatic button accordion is a versatile instrument, distinguished by its button-based keyboard layout and rich tonal possibilities. This section provides an overview of a C system instrument with Stradella and Free Bass systems.   High quality Italian Chromatic Button Accordion with Stradella and Free Bass.   High Quality Italian Chromatic Button Accordion with Free Bass and Stradella. The treble side keyboard is configured in the C System.    "
},
{
  "id": "master-58-b-de-luxe",
  "level": "2",
  "url": "sec-chromatic-button-accordion-intro.html#master-58-b-de-luxe",
  "type": "Figure",
  "number": "1.1.1",
  "title": "",
...
},
{
  ...
  "body": " C Major Scale Construction  In C major, the interval pattern remains the same ascending and descending.  All major scales have the same pattern of intervals, so any major scale can be built by using this same pattern.  The pattern of intervals in a major scale is: whole, whole, half, whole, whole, whole, half. This means that starting from the root note (C in this case), you would move up a whole step to D, then another whole step to E, then a half step to F, then a whole step to G, then a whole step to A, then a whole step to B, and finally a half step back to C.  A whole step (also called a whole tone) consists of two semitones, while a half step (also called a semitone) consists of one semitone. So the interval pattern for the C major scale can also be expressed in terms of semitones as: 2, 2, 1, 2, 2, 2, 1.  The C major scale notes are C, D, E, F, G, A, B, and C.   The 12 notes of the chromatic scale arranged clockwise around a circle, provide a useful means of visualising how scales are constructed by stacking 2nd intervals above the Scale Root note.       C major scale notation on a musical staff (ascending and descending).       Examples of intervals with notation and semitone counts (C major scale).      "
},
{
  "id": "fig-chromatic-scale-clock",
  "level": "2",
  "url": "sec-intervals-c-major-scale.html#fig-chromatic-scale-clock",
  "type": "Figure",
  "number": "2.1.1",
  "title": "",
  "body": " The 12 notes of the chromatic scale arranged clockwise around a circle, provide a useful means of visualising how scales are constructed by stacking 2nd intervals above the Scale Root note.     "
},
{
...
{
  "id": "sec-intervals-c-natural-minor",
  "level": "1",
...
{
  "id": "sec-intervals-c-harmonic-minor-scale",
  "level": "1",
...
{
  "id": "sec-intervals-c-melodic-minor-ascending",
  "level": "1",
...
{
  "id": "fig-intervals-c-melodic-minor-ascending-table",
  "level": "2",
...
{
  "id": "sec-intervals-c-melodic-minor-descending",
  "level": "1",
...
{
  "id": "fig-intervals-c-melodic-minor-descending-table",
  "level": "2",
...
{
  "id": "fig-C-melodic-minor-descending-scale-shape-notation",
  "level": "2",
...
{
  "id": "fig-D-melodic-minor-descending-scale-shape-notation",
  "level": "2",
...
{
  "id": "fig-G-melodic-minor-descending-scale-shape-notation",
  "level": "2",
...
{
  "id": "fig-scale-thirds-clock",
  "level": "2",
  "url": "sec-chords-from-intervals.html#fig-scale-thirds-clock",
  "type": "Figure",
  "number": "5.1.1",
  "title": "",
  "body": " The 7 notes of the C major scale placed at their correct semitone positions around a 12-note circle (Root = C at 12 o'clock, one step = one semitone). Small grey ticks mark the 5 chromatic passing notes that fall between whole-tone scale steps. Moving two scale-degree steps clockwise at a time stacks thirds and builds chord tones: the dashed triangle connects the triad (1–3–5).     "
},
{
...
{
  "id": "subsec-sixth-chords-2",
  "level": "2",
  "url": "sec-extended-sus-chords.html#subsec-sixth-chords-2",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Added sixth chords "
},
{
  "id": "subsec-sixth-chords-3-1-1",
  "level": "2",
  "url": "sec-extended-sus-chords.html#subsec-sixth-chords-3-1-1",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Major sixth (6) "
...
{
  "id": "subsec-sixth-chords-3-2-1",
  "level": "2",
  "url": "sec-extended-sus-chords.html#subsec-sixth-chords-3-2-1",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Minor sixth (m6) "
...
{
  "id": "subsec-sixth-chords-4",
  "level": "2",
  "url": "sec-extended-sus-chords.html#subsec-sixth-chords-4",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "6\/9 chord "
...
{
  "id": "subsec-sixth-chords-5-1-1",
  "level": "2",
  "url": "sec-extended-sus-chords.html#subsec-sixth-chords-5-1-1",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Major 6\/9 (6\/9) "
...
{
  "id": "subsec-sixth-chords-5-2-1",
  "level": "2",
  "url": "sec-extended-sus-chords.html#subsec-sixth-chords-5-2-1",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Minor 6\/9 (m6\/9) "
...
},
{
  ...
  "type": "Section",
  "number": "8.2",
  "title": "Closed Voice Triads from C Major Scale, Roots Ascending in 2nds (Cycle 2)",
  "body": " Closed Voice Triads from C Major Scale, Roots Ascending in 2nds (Cycle 2)                                                                                   "
},
{
  ...
  "type": "Section",
  "number": "8.3",
  "title": "Closed Voice Triads from C Major Scale, Roots rising by diatonic 4th (Cycle 4)",
  "body": " Closed Voice Triads from C Major Scale, Roots rising by diatonic 4th (Cycle 4)                                                                                   "
},
{
  ...
  "type": "Section",
  "number": "8.4",
  "title": "Closed Voice Triads from C Major Scale, Roots Ascending by a Diatonic 6th (Cycle 6)",
  "body": " Closed Voice Triads from C Major Scale, Roots Ascending by a Diatonic 6th (Cycle 6)                                                                                   "
},
{
...
},
{
  ...
  "level": "1",
  "url": "sec-Cmaj-7thChords.html",
  "type": "Section",
  "number": "8.6",
  "title": "7th Chord Voicings from C Major Scale (Descending Voice Leading by Diatonic 6ths)",
  "body": " 7th Chord Voicings from C Major Scale (Descending Voice Leading by Diatonic 6ths)                                                                                                           "
},
{
  "id": "sec-Cmaj-drop2-cycle6",
  "level": "1",
  "url": "sec-Cmaj-drop2-cycle6.html",
  "type": "Section",
  "number": "8.7",
  "title": "Drop 2 Diatonic 7th Chords from C Major Scale (Cycle 6)",
...
{
  "id": "fig-circle-chord-progressions",
  "level": "2",
...
},
{
  ...
  "level": "2",
  "url": "sec-circle-chord-progressions.html#sec-circle-chord-progressions-8",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "ii–V–I "
...
{
  "id": "sec-chord-shells-2",
  "level": "2",
  "url": "sec-chord-shells.html#sec-chord-shells-2",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "chord shell Bud Powell voicing "
},
{
  "id": "sec-chord-shells-5-2",
  "level": "2",
  "url": "sec-chord-shells.html#sec-chord-shells-5-2",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "R+10 "
...
{
  "id": "sec-guide-tones-2",
  "level": "2",
  "url": "sec-guide-tones.html#sec-guide-tones-2",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Guide tones "
...
},
{
  ...
  "level": "2",
  "url": "sec-rootless-voicings.html#sec-rootless-voicings-2",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  ...
  "level": "2",
  "url": "sec-rootless-voicings.html#sec-rootless-voicings-3-3-1-1",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "A voicing "
...
{
  "id": "sec-rootless-voicings-3-3-2-1",
  "level": "2",
  "url": "sec-rootless-voicings.html#sec-rootless-voicings-3-3-2-1",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "B voicing "
...
{
  "id": "sec-block-chords-2",
  "level": "2",
  "url": "sec-block-chords.html#sec-block-chords-2",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Block chords locked hands Shearing-style voicings "
},
{
  "id": "sec-drop2-voicings",
  "level": "1",
...
{
  "id": "sec-drop2-voicings-2",
  "level": "2",
  "url": "sec-drop2-voicings.html#sec-drop2-voicings-2",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Drop 2 voicings "
},
{
  "id": "sec-quartal-voicings",
  "level": "1",
...
{
  "id": "sec-quartal-voicings-2",
  "level": "2",
  "url": "sec-quartal-voicings.html#sec-quartal-voicings-2",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Quartal voicings "
},
{
  "id": "sec-quartal-voicings-7",
  "level": "2",
...
{
  "id": "fig-barry-harris-dim-lesson",
  "level": "2",
...
{
  "id": "sec-barry-harris-dom7-basics",
  "level": "1",
...
{
  "id": "sec-barry-harris-dom7-basics-2-3",
  "level": "2",
  "url": "sec-barry-harris-dom7-basics.html#sec-barry-harris-dom7-basics-2-3",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "B dominant 7th scale "
},
{
  "id": "fig-connor-dom7-p1",
  "level": "2",
...
{
  "id": "subsec-dom7-arpeggios-5",
  "level": "2",
  "url": "sec-barry-harris-dom7-basics.html#subsec-dom7-arpeggios-5",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "augmented arpeggio "
},
{
  "id": "fig-connor-dom7-p3",
  "level": "2",
